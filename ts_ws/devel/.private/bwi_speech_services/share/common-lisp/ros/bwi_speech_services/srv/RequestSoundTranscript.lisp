...
(cl:in-package bwi_speech_services-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <RequestSoundTranscript-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RequestSoundTranscript-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bwi_speech_services-srv:<RequestSoundTranscript-request> is deprecated: use bwi_speech_services-srv:RequestSoundTranscript-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RequestSoundTranscript-request>)))
  ...
  "bwi_speech_services/RequestSoundTranscriptRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RequestSoundTranscript-request)))
  "Returns string type for a service object of type 'RequestSoundTranscript-request"
  "bwi_speech_services/RequestSoundTranscriptRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <RequestSoundTranscript-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RequestSoundTranscript-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bwi_speech_services-srv:<RequestSoundTranscript-response> is deprecated: use bwi_speech_services-srv:RequestSoundTranscript-response instead.")))

(cl:ensure-generic-function 'isGood-val :lambda-list '(m))
(cl:defmethod isGood-val ((m <RequestSoundTranscript-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bwi_speech_services-srv:isGood-val is deprecated.  Use bwi_speech_services-srv:isGood instead.")
  (isGood m))

(cl:ensure-generic-function 'utterance-val :lambda-list '(m))
(cl:defmethod utterance-val ((m <RequestSoundTranscript-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bwi_speech_services-srv:utterance-val is deprecated.  Use bwi_speech_services-srv:utterance instead.")
  (utterance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RequestSoundTranscript-response>)))
  ...
  "bwi_speech_services/RequestSoundTranscriptResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RequestSoundTranscript-response)))
  "Returns string type for a service object of type 'RequestSoundTranscript-response"
  "bwi_speech_services/RequestSoundTranscriptResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RequestSoundTranscript)))
  ...
  "bwi_speech_services/RequestSoundTranscript")