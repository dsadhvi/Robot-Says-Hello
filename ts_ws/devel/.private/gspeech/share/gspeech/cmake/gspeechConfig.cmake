...
if("TRUE" STREQUAL "TRUE")
  set(gspeech_SOURCE_PREFIX /home/tracy/catkin_ws/src/gspeech)
  set(gspeech_DEVEL_PREFIX /home/tracy/catkin_ws/devel/.private/gspeech)
  set(gspeech_INSTALL_PREFIX "")
  set(gspeech_PREFIX ${gspeech_DEVEL_PREFIX})
else()
  set(gspeech_SOURCE_PREFIX "")
  set(gspeech_DEVEL_PREFIX "")
  set(gspeech_INSTALL_PREFIX /home/tracy/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://blog.achuwilson.in " STREQUAL " ")
    set(_report "Check the website 'http://blog.achuwilson.in' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'achuwilsonGEC Sreekrishnapuram+91-9400418468 <example@example.com>, John <pexison@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'gspeech' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'gspeech' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tracy/catkin_ws/src/gspeech/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tracy/catkin_ws/devel/.private/gspeech/lib;/home/tracy/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
